                ...
                c => new
                    {
                        ...
                        Prod_Category = c.Int(nullable: false),
                        Prod_Size = c.Int(nullable: false),
                        Prod_Price = c.String(nullable: false),
                        Prod_Quantity = c.String(nullable: false),
                        Prod_Image = c.String(nullable: false),
                        Category_id = c.Int(),
                        Size_id = c.Int(),
                    })
                .PrimaryKey(t => t.id)
